 ...
 */
 ...
 class Produit {
    ...
    * Attributs
    */
    private int $id, $qteEnStock, $idSousCateg, $seuilAlerte;
    ...
    */
    ...
    int $uneQteEnStock, float $unPrix, int $unSeuilAlerte, int $unIdSousCateg) {
        $this->id = $unId;
        ...
        $this->prix = $unPrix;
        $this->seuilAlerte = $unSeuilAlerte;
    ...
    public function setSeuilAlerte(int $unSeuilAlerte) {
        $this->seuilAlerte = $unSeuilAlerte;
    }
...
class Detail_Prod extends Produit {
    /*
    * Attributs
    */
    private int $id, $qteEnStock, $idSousCateg, $seuilAlerte, $qte;
    private string $refProd, $marque, $libelle, $resume, $description, $photoProd;
    private float $prix;
    ...
    */
    public function __construct(int $unId, string $uneRefProd, string $uneMarque, string $unLibelle, string $unResume, string $uneDescription, string $unePhotoProd, 
    int $uneQteEnStock, float $unPrix, int $unSeuilAlerte = 0, int $unIdSousCateg = 0, int $uneQte = 0) {
        $this->id = $unId;
        $this->refProd = $uneRefProd;
        $this->marque = $uneMarque;
        $this->libelle = $unLibelle;
    ...
    public function setQte(int $uneQte) {
        $this->qte = $uneQte;
    }
